...
class AddRestaurant extends Component {
  ...
  formValidation = () =>{
  const{userId,restaurantName,phoneNumber,restaurantAddress,city,restaurantImg}= this.state;
  let isValid = true;
  const errors ={};
...
return isValid;
	...
	submitHandler = e => {
      ...
      if(isValid)
      {
        alert("Restaraunt Added Successfully")
        console.log(this.state)
		axios
			.post('https://localhost:5001/api/RestaurantOwner/AddRestaurant', this.state )
	...
	render() {
    const{userId,restaurantName,phoneNumber,restaurantAddress,city,restaurantImg,errors}= this.state;
		return (
